...
const Rooms = () => {
    ...
    const generateRoomCards = (count) => {
        ...
        for (let i = 0; i < count; i++) {
            cards.push(
                <div key={i} className="roomCard w-64 rounded-lg bg-white p-2 flex-shrink-0">
                    <div className="img">
                        <img src={img1} alt="Room" className='w-64 h-full rounded-lg mt-2 mb-2' />
                    </div>
        ...
        <section id='rooms' className='mt-10 h-min mb-20'>
            <div id='mainDiv'>
                <div className='text-center w-4/5 mx-auto mb-10'>
                    ...
                    <h2 className='lg:text-5xl md:text-4xl font-rubik text-cyan-950 mt-4'>SUITES & ROOMS</h2>
                ...
                <div className='flex md:flex-row flex-col gap-0 w-5/6 mx-auto justify-center items-center'>
                    <h1 className='lg:text-3xl md:text-[25px] font-semibold text-cyan-900 md:w-3/4 text-center underline'>THE CLUB LEVEL</h1>
                    <p className='lg:text-xl md:text-[13px] text-cyan-950 font-rubik text-xs mt-2 mb-2'>Located on the top floor, The Sapphire Retreat's® Lounge is an exclusive space for guests to work or relax while enjoying scintillating views of the Bangalore skyline. The Ritz-Carlton Club Experience commences on arrival and offers guests extraordinary service and sophistication.</p>
                </div>
                ...
                <div id='cardDiv'>
                    ...
                    <div id='PremiumRooms' className='mt-10 m-2'>
                        <div className='h-[1px] bg-cyan-950 m-5 ml-9 mr-9'></div>
                        <h1 className='text-3xl text-center text-cyan-950'> Premium Rooms</h1>
                        <p className='text-cyan-900 mt-4 mb-3 w-4/5 mx-auto'>Premium rooms cater to guests seeking a higher level of comfort and luxury. These rooms are characterized by elegant furnishings, luxurious bedding, and enhanced bathroom amenities. Guests can enjoy breathtaking views or premium location within the hotel, along with personalized services to enhance their stay.</p>
                        <div className="roomCards ml-5 mt-10 flex flex-row gap-3 overflow-x-auto">
                            {generateRoomCards(7)}
                        </div>
                        <div className='h-[1px] bg-cyan-950 m-5 ml-9 mr-9'></div>
